...
- Token is requested locally with getpass; never stored.
...
OUT_MATCHED = "rs20_program_flow_collection_status_v1.csv"
OUT_MISSING = "rs20_program_flow_missing_v1.csv"
OUT_PROGRESS = "rs20_program_flow_progress_v1.csv"
OUT_SUMMARY = "rs20_program_flow_collection_summary_v1.txt"
...
def main():
    ...
    print("=" * 94)
    print("RS20 PROGRAM_FLOW COLLECTOR v1")
    ...
    token = getpass("Kiwoom ACCESS TOKEN (input hidden): ").strip()
    if not token:
        raise SystemExit("ACCESS TOKEN is empty.")
