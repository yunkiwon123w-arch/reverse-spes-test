...
def main():
    print("=" * 78)
    print("Reverse SPES - RS3 실시간 위험단계 검증 v1.1")
    print("원문 RS3 규칙 변경 없음 / 결과는 전용 폴더에 새 파일로 저장")
    print("=" * 78)
    ...
    # 기존 CSV 잠금/동기화 충돌을 피하기 위해 전용 결과 폴더 사용.
    ...
    print()
    print("이번 버전은 실행 시각을 파일명에 붙여 기존 파일과 충돌하지 않습니다.")
